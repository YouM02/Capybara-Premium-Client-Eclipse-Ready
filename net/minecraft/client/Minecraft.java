...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public fun.rich.client.font.MCFontRenderer latoBig;
    public fun.rich.client.font.MCFontRenderer latoFontRender;
   ...
   //     }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Rich.instance.name + " " + Rich.instance.type + " - https://vk.com/capybaraclient");
